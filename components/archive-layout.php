<div class="custom-layout project">
        <?php if( have_rows('archive_layout') ): ?>
            <?php while ( have_rows('archive_layout') ) : the_row(); ?>
                            ...
                            <?php if( have_rows('c3_column_one_content') ): ?>
                                <?php while ( have_rows('c3_column_one_content') ) : the_row(); ?>
                                    ...
                                    <?php if(get_sub_field('c3_column_one_content_select') === 'image'): ?>
                                        <div class="jc_rte-image">
                                            <?php if(get_sub_field('c3_column_one_content_linkable')): ?>
                                                <a href="<?php the_sub_field('c3_column_one_content_link'); ?>">
                                            <?php endif; ?>
                                            <?php
                                            ...
                                            <img src="<?php echo $image[0]; ?>" alt="">
                                            <?php if(get_sub_field('c3_column_one_content_linkable')): ?>
                                                <h2><?php the_sub_field('c3_column_one_content_link_text'); ?></h2>
                                            <?php endif; ?>
                                            <?php if(get_sub_field('c3_column_one_content_linkable')): ?>
                                                </a>
                                            <?php endif; ?>
